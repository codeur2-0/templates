"""Pytest fixtures for the ecommerce-catalog-recommendation-sklearn project.

Trois règles de conception, appliquées partout dans cette suite :

* **rapidité** — chaque fixture construit un *petit* jeu de données (600 lignes) plutôt que le
...
def raw_dataset_path(raw_dataset: pd.DataFrame, tmp_path_factory: pytest.TempPathFactory) -> Path:
    ...
    path = directory / "ecommerce_candidate_impressions.parquet"
