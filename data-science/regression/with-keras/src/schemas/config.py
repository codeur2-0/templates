...
class ProjectConfig(BaseModel):
    ...
    key: str = "ds-regression-keras"
    name: str = "real-estate-avm-keras"
    domain: str = "data-science"
    problem: str = "regression"
    stack: str = "keras"
    family: str = "regression"
    modality: str = "tabular"
    title: str = "Estimation du prix de vente immobilier (AVM) avec Keras (API fonctionnelle)"
    version: str = "1.0.0"
...
class ModelConfig(BaseModel):
    ...
    name: str = "Réseau de neurones Keras (API fonctionnelle)"
    algorithm: str = "mlp"
    model_class: str = Field(default="KerasModel", alias="class")
