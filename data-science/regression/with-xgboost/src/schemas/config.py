...
class ProjectConfig(BaseModel):
    ...
    key: str = "ds-regression-xgboost"
    name: str = "real-estate-avm-xgboost"
    domain: str = "data-science"
    problem: str = "regression"
    stack: str = "xgboost"
    family: str = "regression"
    modality: str = "tabular"
    title: str = "Estimation du prix de vente immobilier (AVM) avec XGBoost"
    version: str = "1.0.0"
...
class ModelConfig(BaseModel):
    ...
    name: str = "Gradient boosting XGBoost (régression)"
    algorithm: str = "xgboost"
    model_class: str = Field(default="XGBoostModel", alias="class")
