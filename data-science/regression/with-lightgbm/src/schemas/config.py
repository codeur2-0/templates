...
class ProjectConfig(BaseModel):
    ...
    key: str = "ds-regression-lightgbm"
    name: str = "real-estate-avm-lightgbm"
    domain: str = "data-science"
    problem: str = "regression"
    stack: str = "lightgbm"
    family: str = "regression"
    modality: str = "tabular"
    title: str = "Estimation du prix de vente immobilier (AVM) avec LightGBM"
    version: str = "1.0.0"
...
class ModelConfig(BaseModel):
    ...
    name: str = "Gradient boosting LightGBM (régression)"
