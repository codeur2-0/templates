...
class ProjectConfig(BaseModel):
    ...
    key: str = "ds-regression-sklearn"
    name: str = "real-estate-avm-sklearn"
    domain: str = "data-science"
    problem: str = "regression"
    stack: str = "sklearn"
    family: str = "regression"
    modality: str = "tabular"
    title: str = "Estimation du prix de vente immobilier (AVM) avec scikit-learn"
    version: str = "1.0.0"
...
class ModelConfig(BaseModel):
    ...
    name: str = "Gradient boosting histogrammé scikit-learn (régression)"
