...
class ProjectConfig(BaseModel):
    ...
    key: str = "ds-regression-pytorch"
    name: str = "real-estate-avm-pytorch"
    domain: str = "data-science"
    problem: str = "regression"
    stack: str = "pytorch"
    family: str = "regression"
    modality: str = "tabular"
    title: str = "Estimation du prix de vente immobilier (AVM) avec PyTorch"
    version: str = "1.0.0"
...
class ModelConfig(BaseModel):
    ...
    name: str = "Réseau de neurones PyTorch (MLP)"
    algorithm: str = "mlp"
    model_class: str = Field(default="PyTorchModel", alias="class")
