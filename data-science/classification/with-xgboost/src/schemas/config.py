...
class ProjectConfig(BaseModel):
    ...
    key: str = "ds-classification-xgboost"
    name: str = "telecom-churn-xgboost"
    domain: str = "data-science"
    problem: str = "classification"
    stack: str = "xgboost"
    family: str = "binary_classification"
    modality: str = "tabular"
    title: str = "Prédiction d'attrition client (churn télécom) avec XGBoost"
    version: str = "1.0.0"
...
class ModelConfig(BaseModel):
    ...
    name: str = "Gradient boosting XGBoost"
