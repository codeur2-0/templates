...
class ProjectConfig(BaseModel):
    ...
    key: str = "ds-classification-sklearn"
    name: str = "telecom-churn-sklearn"
    domain: str = "data-science"
    problem: str = "classification"
    stack: str = "sklearn"
    family: str = "binary_classification"
    modality: str = "tabular"
    title: str = "Prédiction d'attrition client (churn télécom) avec scikit-learn"
    version: str = "1.0.0"
...
class ModelConfig(BaseModel):
    ...
    name: str = "Forêt aléatoire scikit-learn"
