"""Pytest fixtures for the electricity-load-forecasting-sklearn project.

Trois règles de conception, appliquées partout dans cette suite :

* **rapidité** — chaque fixture construit un *petit* jeu de données (400 lignes) plutôt que le
...
def raw_dataset_path(raw_dataset: pd.DataFrame, tmp_path_factory: pytest.TempPathFactory) -> Path:
    ...
    path = directory / "regional_electricity_load.parquet"
