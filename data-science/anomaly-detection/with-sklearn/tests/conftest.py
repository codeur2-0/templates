"""Pytest fixtures for the payment-fraud-detection-sklearn project.

Trois règles de conception, appliquées partout dans cette suite :

* **rapidité** — chaque fixture construit un *petit* jeu de données (3000 lignes) plutôt que le
...
def raw_dataset_path(raw_dataset: pd.DataFrame, tmp_path_factory: pytest.TempPathFactory) -> Path:
    ...
    path = directory / "payment_transactions.parquet"
