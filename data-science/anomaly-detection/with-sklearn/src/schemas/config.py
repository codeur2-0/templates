...
class ProjectConfig(BaseModel):
    ...
    key: str = "ds-anomaly-sklearn"
    name: str = "payment-fraud-detection-sklearn"
    domain: str = "data-science"
    problem: str = "anomaly-detection"
    stack: str = "sklearn"
    family: str = "anomaly_detection"
    modality: str = "tabular"
    title: str = "Détection de fraude sur transactions de paiement avec scikit-learn"
    version: str = "1.0.0"
...
class DataConfig(BaseModel):
    ...
    dataset_name: str = "payment_transactions"
    n_samples: int = Field(default=12000, ge=50)
    seed: int = 42
    ...
    id_column: str | None = "transaction_id"
    time_column: str | None = "occurred_at"
    group_column: str | None = "merchant_category"
    positive_rate: float | None = Field(default=0.018, ge=0.0, le=1.0)
...
class ModelConfig(BaseModel):
    ...
    name: str = "Forêt d'isolation (Isolation Forest)"
...
class MetricsConfig(BaseModel):
    ...
    baseline: str = "random_score"
    direction: Literal["maximize", "minimize"] = "maximize"
    min_primary: float | None = 0.42
