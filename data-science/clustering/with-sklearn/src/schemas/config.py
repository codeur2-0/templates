...
class ProjectConfig(BaseModel):
    ...
    key: str = "ds-clustering-sklearn"
    name: str = "retail-customer-segmentation-sklearn"
    domain: str = "data-science"
    problem: str = "clustering"
    stack: str = "sklearn"
    family: str = "clustering"
    modality: str = "tabular"
    title: str = "Segmentation client d'un e-commerçant (RFM étendu) avec scikit-learn"
    version: str = "1.0.0"
...
class DataConfig(BaseModel):
    ...
    dataset_name: str = "retail_customer_base"
    n_samples: int = Field(default=6000, ge=50)
    seed: int = 42
    ...
    time_column: str | None = "signup_date"
    group_column: str | None = "acquisition_channel"
...
class ModelConfig(BaseModel):
    ...
    name: str = "KMeans (initialisation k-means++)"
...
class MetricsConfig(BaseModel):
    ...
    secondary: list[str] = Field(
        default_factory=lambda: ["calinski_harabasz", "davies_bouldin", "n_clusters"]
    )
