...
class TestModelContract:
    ...
    def test_model_records_the_feature_contract(self, model: BaseModel, prepared: dict[str, Any]) -> None:
        """Le modèle connaît exactement les features attendues, dans l'ordre."""
        assert model.feature_names == prepared["feature_names"]

    def test_unfitted_model_refuses_to_predict(self, model: BaseModel, matrices: dict[str, Any]) -> None:
...
class TestPrediction:
    ...
    def test_predict_returns_one_value_per_row(self, fitted_model: BaseModel, matrices: dict[str, Any]) -> None:
    ...
    def test_predict_proba_is_normalised(self, fitted_model: BaseModel, matrices: dict[str, Any]) -> None:
    ...
    def test_predict_proba_is_refused_when_unsupported(self, model: BaseModel, matrices: dict[str, Any]) -> None:
    ...
    def test_prediction_on_a_single_row(self, fitted_model: BaseModel, matrices: dict[str, Any]) -> None:
    ...
    def test_prediction_is_deterministic_at_inference(self, fitted_model: BaseModel, matrices: dict[str, Any]) -> None:
...
class TestFeatureAlignment:
    ...
    def test_missing_feature_is_refused(self, fitted_model: BaseModel, matrices: dict[str, Any]) -> None:
    ...
    def test_predict_accepts_reordered_columns(self, fitted_model: BaseModel, matrices: dict[str, Any]) -> None:
...
class TestPersistence:
    ...
    def test_load_model_helper_returns_a_base_model(self, fitted_model: BaseModel, tmp_path: Path) -> None:
...
class TestModelFactory:
    ...
    def test_build_model_uses_the_configuration(self, app_config: Any, prepared: dict[str, Any]) -> None:
    ...
    def test_every_configured_algorithm_can_be_built(self, app_config: Any, prepared: dict[str, Any]) -> None:
